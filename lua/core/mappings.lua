...
if vim.g.is_lsp_enabled then
	...
	vim.keymap.set('n', '<leader>lD', ':lua vim.lsp.buf.declaration()<CR>', { silent = true })
	vim.keymap.set('n', '<leader>lK', ':lua vim.lsp.buf.hover()<CR>', { silent = true })
	vim.keymap.set('n', '<leader>lr', ':lua vim.lsp.buf.references()<CR>', { silent = true })
	vim.keymap.set('n', '<leader>lt', ':lua vim.lsp.buf.type_definition()<CR>', { silent = true })
	vim.keymap.set('n', '<leader>lR', ':lua vim.lsp.buf.rename()<CR>', { silent = true })
